...
def get_proxy():
    try:
        ...
        return False,""
# 网易财经
# https://money.163.com/special/00259BVP/news_flow_index_09.js 财经


main_url = "https://money.163.com/special/00259BVP/news_flow_index_"
#翻页次数
i = 1
count = 9
timeout = 5
...
send_dingding(["资讯--财经板块去重后一共推送 :%s" %crawlcount])