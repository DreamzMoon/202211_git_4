...
def tran_hold():
    try:
        ...
        #可转让 持有
        sql = '''
        select hold_phone, pretty_type_id, date_format(thaw_time,"%Y-%m-%d") thaw_time, is_sell, pay_type, date_format(create_time,"%Y-%m-%d") create_time, status from lh_pretty_hold_0 where del_flag=0 and `status` in (0,1,2) and is_open_vip = 0 and (DATE_FORMAT(create_time,"%Y-%m-%d") = date_sub(current_date, interval 1 day) or DATE_FORMAT(thaw_time,"%Y-%m-%d") = date_sub(current_date, interval 1 day)) union all
        select hold_phone, pretty_type_id, date_format(thaw_time,"%Y-%m-%d") thaw_time, is_sell, pay_type, date_format(create_time,"%Y-%m-%d") create_time, status from lh_pretty_hold_1 where del_flag=0 and `status` in (0,1,2) and is_open_vip = 0 and (DATE_FORMAT(create_time,"%Y-%m-%d") = date_sub(current_date, interval 1 day) or DATE_FORMAT(thaw_time,"%Y-%m-%d") = date_sub(current_date, interval 1 day)) union all
        select hold_phone, pretty_type_id, date_format(thaw_time,"%Y-%m-%d") thaw_time, is_sell, pay_type, date_format(create_time,"%Y-%m-%d") create_time, status from lh_pretty_hold_2 where del_flag=0 and `status` in (0,1,2) and is_open_vip = 0 and (DATE_FORMAT(create_time,"%Y-%m-%d") = date_sub(current_date, interval 1 day) or DATE_FORMAT(thaw_time,"%Y-%m-%d") = date_sub(current_date, interval 1 day)) union all
        select hold_phone, pretty_type_id, date_format(thaw_time,"%Y-%m-%d") thaw_time, is_sell, pay_type, date_format(create_time,"%Y-%m-%d") create_time, status from lh_pretty_hold_3 where del_flag=0 and `status` in (0,1,2) and is_open_vip = 0 and (DATE_FORMAT(create_time,"%Y-%m-%d") = date_sub(current_date, interval 1 day) or DATE_FORMAT(thaw_time,"%Y-%m-%d") = date_sub(current_date, interval 1 day)) union all
        select hold_phone, pretty_type_id, date_format(thaw_time,"%Y-%m-%d") thaw_time, is_sell, pay_type, date_format(create_time,"%Y-%m-%d") create_time, status from lh_pretty_hold_4 where del_flag=0 and `status` in (0,1,2) and is_open_vip = 0 and (DATE_FORMAT(create_time,"%Y-%m-%d") = date_sub(current_date, interval 1 day) or DATE_FORMAT(thaw_time,"%Y-%m-%d") = date_sub(current_date, interval 1 day)) union all
        select hold_phone, pretty_type_id, date_format(thaw_time,"%Y-%m-%d") thaw_time, is_sell, pay_type, date_format(create_time,"%Y-%m-%d") create_time, status from lh_pretty_hold_5 where del_flag=0 and `status` in (0,1,2) and is_open_vip = 0 and (DATE_FORMAT(create_time,"%Y-%m-%d") = date_sub(current_date, interval 1 day) or DATE_FORMAT(thaw_time,"%Y-%m-%d") = date_sub(current_date, interval 1 day)) union all
        select hold_phone, pretty_type_id, date_format(thaw_time,"%Y-%m-%d") thaw_time, is_sell, pay_type, date_format(create_time,"%Y-%m-%d") create_time, status from lh_pretty_hold_6 where del_flag=0 and `status` in (0,1,2) and is_open_vip = 0 and (DATE_FORMAT(create_time,"%Y-%m-%d") = date_sub(current_date, interval 1 day) or DATE_FORMAT(thaw_time,"%Y-%m-%d") = date_sub(current_date, interval 1 day)) union all
        select hold_phone, pretty_type_id, date_format(thaw_time,"%Y-%m-%d") thaw_time, is_sell, pay_type, date_format(create_time,"%Y-%m-%d") create_time, status from lh_pretty_hold_7 where del_flag=0 and `status` in (0,1,2) and is_open_vip = 0 and (DATE_FORMAT(create_time,"%Y-%m-%d") = date_sub(current_date, interval 1 day) or DATE_FORMAT(thaw_time,"%Y-%m-%d") = date_sub(current_date, interval 1 day)) union all
        select hold_phone, pretty_type_id, date_format(thaw_time,"%Y-%m-%d") thaw_time, is_sell, pay_type, date_format(create_time,"%Y-%m-%d") create_time, status from lh_pretty_hold_8 where del_flag=0 and `status` in (0,1,2) and is_open_vip = 0 and (DATE_FORMAT(create_time,"%Y-%m-%d") = date_sub(current_date, interval 1 day) or DATE_FORMAT(thaw_time,"%Y-%m-%d") = date_sub(current_date, interval 1 day)) union all
        select hold_phone, pretty_type_id, date_format(thaw_time,"%Y-%m-%d") thaw_time, is_sell, pay_type, date_format(create_time,"%Y-%m-%d") create_time, status from lh_pretty_hold_9 where del_flag=0 and `status` in (0,1,2) and is_open_vip = 0 and (DATE_FORMAT(create_time,"%Y-%m-%d") = date_sub(current_date, interval 1 day) or DATE_FORMAT(thaw_time,"%Y-%m-%d") = date_sub(current_date, interval 1 day)) union all
        select hold_phone, pretty_type_id, date_format(thaw_time,"%Y-%m-%d") thaw_time, is_sell, pay_type, date_format(create_time,"%Y-%m-%d") create_time, status from lh_pretty_hold_a where del_flag=0 and `status` in (0,1,2) and is_open_vip = 0 and (DATE_FORMAT(create_time,"%Y-%m-%d") = date_sub(current_date, interval 1 day) or DATE_FORMAT(thaw_time,"%Y-%m-%d") = date_sub(current_date, interval 1 day)) union all
        select hold_phone, pretty_type_id, date_format(thaw_time,"%Y-%m-%d") thaw_time, is_sell, pay_type, date_format(create_time,"%Y-%m-%d") create_time, status from lh_pretty_hold_b where del_flag=0 and `status` in (0,1,2) and is_open_vip = 0 and (DATE_FORMAT(create_time,"%Y-%m-%d") = date_sub(current_date, interval 1 day) or DATE_FORMAT(thaw_time,"%Y-%m-%d") = date_sub(current_date, interval 1 day)) union all
        select hold_phone, pretty_type_id, date_format(thaw_time,"%Y-%m-%d") thaw_time, is_sell, pay_type, date_format(create_time,"%Y-%m-%d") create_time, status from lh_pretty_hold_c where del_flag=0 and `status` in (0,1,2) and is_open_vip = 0 and (DATE_FORMAT(create_time,"%Y-%m-%d") = date_sub(current_date, interval 1 day) or DATE_FORMAT(thaw_time,"%Y-%m-%d") = date_sub(current_date, interval 1 day)) union all
        select hold_phone, pretty_type_id, date_format(thaw_time,"%Y-%m-%d") thaw_time, is_sell, pay_type, date_format(create_time,"%Y-%m-%d") create_time, status from lh_pretty_hold_d where del_flag=0 and `status` in (0,1,2) and is_open_vip = 0 and (DATE_FORMAT(create_time,"%Y-%m-%d") = date_sub(current_date, interval 1 day) or DATE_FORMAT(thaw_time,"%Y-%m-%d") = date_sub(current_date, interval 1 day)) union all
        select hold_phone, pretty_type_id, date_format(thaw_time,"%Y-%m-%d") thaw_time, is_sell, pay_type, date_format(create_time,"%Y-%m-%d") create_time, status from lh_pretty_hold_e where del_flag=0 and `status` in (0,1,2) and is_open_vip = 0 and (DATE_FORMAT(create_time,"%Y-%m-%d") = date_sub(current_date, interval 1 day) or DATE_FORMAT(thaw_time,"%Y-%m-%d") = date_sub(current_date, interval 1 day)) union all
        select hold_phone, pretty_type_id, date_format(thaw_time,"%Y-%m-%d") thaw_time, is_sell, pay_type, date_format(create_time,"%Y-%m-%d") create_time, status from lh_pretty_hold_f where del_flag=0 and `status` in (0,1,2) and is_open_vip = 0 and (DATE_FORMAT(create_time,"%Y-%m-%d") = date_sub(current_date, interval 1 day) or DATE_FORMAT(thaw_time,"%Y-%m-%d") = date_sub(current_date, interval 1 day))
        '''
...
def user_mes():
    try:
        ...
        sql = '''
        select if(`name`,`name`,nickname) nickname,phone hold_phone,unionid,operatename,parentid from crm_user_%s where del_flag = 0 and phone != "" and phone is not null
        ''' % current_time
...
if __name__ == "__main__":
    ...
    while True:
        ...
        df_merge.to_sql('user_storage_value_1', con=conn_analyze, if_exists="append", index=False)
        df_merge.to_csv(r'D:/update_df.csv', encoding='gb18030', index=False)
        run_end = time.time()
