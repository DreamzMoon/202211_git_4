# -*- coding: utf-8 -*-
# @Time : 2021/12/20  14:22
# @Author : shihong
# @File : .py
# --------------------------------------
'''更新用户每日名片网数据统计表---每天00:01分同步数据'''
import os
import sys
...
def public_lh():
    try:
        ...
        group by day_time,hold_phone ) t group by day_time,hold_phone having day_time = date_sub(current_date, interval 1 day) order by day_time desc
        '''
...
def tran_hold():
    try:
        ...
        #可转让 持有
        sql = '''
            select if(hold_phone,hold_phone,hold_user_id) hold_phone, pretty_type_id, date_format(thaw_time,"%Y-%m-%d") thaw_time,date_format(if(pay_time is not null,pay_time,create_time),"%Y-%m-%d") pay_time, is_sell, pay_type, date_format(create_time,"%Y-%m-%d") create_time, status from lh_pretty_hold_0 where del_flag=0 and `status` in (0,1,2) and is_open_vip = 0 and (thaw_time<=now() or create_time<=now())  union all
            select if(hold_phone,hold_phone,hold_user_id) hold_phone, pretty_type_id, date_format(thaw_time,"%Y-%m-%d") thaw_time,date_format(if(pay_time is not null,pay_time,create_time),"%Y-%m-%d") pay_time, is_sell, pay_type, date_format(create_time,"%Y-%m-%d") create_time, status from lh_pretty_hold_1 where del_flag=0 and `status` in (0,1,2) and is_open_vip = 0 and (thaw_time<=now() or create_time<=now())  union all
            select if(hold_phone,hold_phone,hold_user_id) hold_phone, pretty_type_id, date_format(thaw_time,"%Y-%m-%d") thaw_time,date_format(if(pay_time is not null,pay_time,create_time),"%Y-%m-%d") pay_time, is_sell, pay_type, date_format(create_time,"%Y-%m-%d") create_time, status from lh_pretty_hold_2 where del_flag=0 and `status` in (0,1,2) and is_open_vip = 0 and (thaw_time<=now() or create_time<=now())  union all
            select if(hold_phone,hold_phone,hold_user_id) hold_phone, pretty_type_id, date_format(thaw_time,"%Y-%m-%d") thaw_time,date_format(if(pay_time is not null,pay_time,create_time),"%Y-%m-%d") pay_time, is_sell, pay_type, date_format(create_time,"%Y-%m-%d") create_time, status from lh_pretty_hold_3 where del_flag=0 and `status` in (0,1,2) and is_open_vip = 0 and (thaw_time<=now() or create_time<=now())  union all
            select if(hold_phone,hold_phone,hold_user_id) hold_phone, pretty_type_id, date_format(thaw_time,"%Y-%m-%d") thaw_time,date_format(if(pay_time is not null,pay_time,create_time),"%Y-%m-%d") pay_time, is_sell, pay_type, date_format(create_time,"%Y-%m-%d") create_time, status from lh_pretty_hold_4 where del_flag=0 and `status` in (0,1,2) and is_open_vip = 0 and (thaw_time<=now() or create_time<=now())  union all
            select if(hold_phone,hold_phone,hold_user_id) hold_phone, pretty_type_id, date_format(thaw_time,"%Y-%m-%d") thaw_time,date_format(if(pay_time is not null,pay_time,create_time),"%Y-%m-%d") pay_time, is_sell, pay_type, date_format(create_time,"%Y-%m-%d") create_time, status from lh_pretty_hold_5 where del_flag=0 and `status` in (0,1,2) and is_open_vip = 0 and (thaw_time<=now() or create_time<=now())  union all
            select if(hold_phone,hold_phone,hold_user_id) hold_phone, pretty_type_id, date_format(thaw_time,"%Y-%m-%d") thaw_time,date_format(if(pay_time is not null,pay_time,create_time),"%Y-%m-%d") pay_time, is_sell, pay_type, date_format(create_time,"%Y-%m-%d") create_time, status from lh_pretty_hold_6 where del_flag=0 and `status` in (0,1,2) and is_open_vip = 0 and (thaw_time<=now() or create_time<=now())  union all
            ...
            select if(hold_phone,hold_phone,hold_user_id) hold_phone, pretty_type_id, date_format(thaw_time,"%Y-%m-%d") thaw_time,date_format(if(pay_time is not null,pay_time,create_time),"%Y-%m-%d") pay_time, is_sell, pay_type, date_format(create_time,"%Y-%m-%d") create_time, status from lh_pretty_hold_8 where del_flag=0 and `status` in (0,1,2) and is_open_vip = 0 and (thaw_time<=now() or create_time<=now())  union all
            select if(hold_phone,hold_phone,hold_user_id) hold_phone, pretty_type_id, date_format(thaw_time,"%Y-%m-%d") thaw_time,date_format(if(pay_time is not null,pay_time,create_time),"%Y-%m-%d") pay_time, is_sell, pay_type, date_format(create_time,"%Y-%m-%d") create_time, status from lh_pretty_hold_9 where del_flag=0 and `status` in (0,1,2) and is_open_vip = 0 and (thaw_time<=now() or create_time<=now())  union all
            select if(hold_phone,hold_phone,hold_user_id) hold_phone, pretty_type_id, date_format(thaw_time,"%Y-%m-%d") thaw_time,date_format(if(pay_time is not null,pay_time,create_time),"%Y-%m-%d") pay_time, is_sell, pay_type, date_format(create_time,"%Y-%m-%d") create_time, status from lh_pretty_hold_a where del_flag=0 and `status` in (0,1,2) and is_open_vip = 0 and (thaw_time<=now() or create_time<=now())  union all
            select if(hold_phone,hold_phone,hold_user_id) hold_phone, pretty_type_id, date_format(thaw_time,"%Y-%m-%d") thaw_time,date_format(if(pay_time is not null,pay_time,create_time),"%Y-%m-%d") pay_time, is_sell, pay_type, date_format(create_time,"%Y-%m-%d") create_time, status from lh_pretty_hold_b where del_flag=0 and `status` in (0,1,2) and is_open_vip = 0 and (thaw_time<=now() or create_time<=now())  union all
            select if(hold_phone,hold_phone,hold_user_id) hold_phone, pretty_type_id, date_format(thaw_time,"%Y-%m-%d") thaw_time,date_format(if(pay_time is not null,pay_time,create_time),"%Y-%m-%d") pay_time, is_sell, pay_type, date_format(create_time,"%Y-%m-%d") create_time, status from lh_pretty_hold_c where del_flag=0 and `status` in (0,1,2) and is_open_vip = 0 and (thaw_time<=now() or create_time<=now())  union all
            select if(hold_phone,hold_phone,hold_user_id) hold_phone, pretty_type_id, date_format(thaw_time,"%Y-%m-%d") thaw_time,date_format(if(pay_time is not null,pay_time,create_time),"%Y-%m-%d") pay_time, is_sell, pay_type, date_format(create_time,"%Y-%m-%d") create_time, status from lh_pretty_hold_d where del_flag=0 and `status` in (0,1,2) and is_open_vip = 0 and (thaw_time<=now() or create_time<=now())  union all
            select if(hold_phone,hold_phone,hold_user_id) hold_phone, pretty_type_id, date_format(thaw_time,"%Y-%m-%d") thaw_time,date_format(if(pay_time is not null,pay_time,create_time),"%Y-%m-%d") pay_time, is_sell, pay_type, date_format(create_time,"%Y-%m-%d") create_time, status from lh_pretty_hold_e where del_flag=0 and `status` in (0,1,2) and is_open_vip = 0 and (thaw_time<=now() or create_time<=now())  union all
            select if(hold_phone,hold_phone,hold_user_id) hold_phone, pretty_type_id, date_format(thaw_time,"%Y-%m-%d") thaw_time,date_format(if(pay_time is not null,pay_time,create_time),"%Y-%m-%d") pay_time, is_sell, pay_type, date_format(create_time,"%Y-%m-%d") create_time, status from lh_pretty_hold_f where del_flag=0 and `status` in (0,1,2) and is_open_vip = 0 and (thaw_time<=now() or create_time<=now())
        '''
...
def no_tran_lh():
    try:
        ...
        # 可转让 持有
        sql = '''
            SELECT hold_phone,pretty_id,pretty_type_id,date_format(if(update_time is not null,update_time,create_time),"%Y-%m-%d") update_time FROM lh_pretty_hold_0 WHERE del_flag=0 AND is_open_vip=0 AND STATUS=0 and pretty_id not in (SELECT pretty_id FROM lh_pretty_hold_0 WHERE STATUS=0 AND is_open_vip=0 AND thaw_time<=now() AND del_flag=0 AND is_sell=1 AND pay_type !=0) union all 
            SELECT hold_phone,pretty_id,pretty_type_id,date_format(if(update_time is not null,update_time,create_time),"%Y-%m-%d") update_time FROM lh_pretty_hold_1 WHERE del_flag=0 AND is_open_vip=0 AND STATUS=0 and pretty_id not in (SELECT pretty_id FROM lh_pretty_hold_1 WHERE STATUS=0 AND is_open_vip=0 AND thaw_time<=now() AND del_flag=0 AND is_sell=1 AND pay_type !=0) union all
            SELECT hold_phone,pretty_id,pretty_type_id,date_format(if(update_time is not null,update_time,create_time),"%Y-%m-%d") update_time FROM lh_pretty_hold_2 WHERE del_flag=0 AND is_open_vip=0 AND STATUS=0 and pretty_id not in (SELECT pretty_id FROM lh_pretty_hold_2 WHERE STATUS=0 AND is_open_vip=0 AND thaw_time<=now() AND del_flag=0 AND is_sell=1 AND pay_type !=0) union all
            SELECT hold_phone,pretty_id,pretty_type_id,date_format(if(update_time is not null,update_time,create_time),"%Y-%m-%d") update_time FROM lh_pretty_hold_3 WHERE del_flag=0 AND is_open_vip=0 AND STATUS=0 and pretty_id not in (SELECT pretty_id FROM lh_pretty_hold_3 WHERE STATUS=0 AND is_open_vip=0 AND thaw_time<=now() AND del_flag=0 AND is_sell=1 AND pay_type !=0) union all
            SELECT hold_phone,pretty_id,pretty_type_id,date_format(if(update_time is not null,update_time,create_time),"%Y-%m-%d") update_time FROM lh_pretty_hold_4 WHERE del_flag=0 AND is_open_vip=0 AND STATUS=0 and pretty_id not in (SELECT pretty_id FROM lh_pretty_hold_4 WHERE STATUS=0 AND is_open_vip=0 AND thaw_time<=now() AND del_flag=0 AND is_sell=1 AND pay_type !=0) union all
            SELECT hold_phone,pretty_id,pretty_type_id,date_format(if(update_time is not null,update_time,create_time),"%Y-%m-%d") update_time FROM lh_pretty_hold_5 WHERE del_flag=0 AND is_open_vip=0 AND STATUS=0 and pretty_id not in (SELECT pretty_id FROM lh_pretty_hold_5 WHERE STATUS=0 AND is_open_vip=0 AND thaw_time<=now() AND del_flag=0 AND is_sell=1 AND pay_type !=0) union all
            SELECT hold_phone,pretty_id,pretty_type_id,date_format(if(update_time is not null,update_time,create_time),"%Y-%m-%d") update_time FROM lh_pretty_hold_6 WHERE del_flag=0 AND is_open_vip=0 AND STATUS=0 and pretty_id not in (SELECT pretty_id FROM lh_pretty_hold_6 WHERE STATUS=0 AND is_open_vip=0 AND thaw_time<=now() AND del_flag=0 AND is_sell=1 AND pay_type !=0) union all
            SELECT hold_phone,pretty_id,pretty_type_id,date_format(if(update_time is not null,update_time,create_time),"%Y-%m-%d") update_time FROM lh_pretty_hold_7 WHERE del_flag=0 AND is_open_vip=0 AND STATUS=0 and pretty_id not in (SELECT pretty_id FROM lh_pretty_hold_7 WHERE STATUS=0 AND is_open_vip=0 AND thaw_time<=now() AND del_flag=0 AND is_sell=1 AND pay_type !=0) union all
            SELECT hold_phone,pretty_id,pretty_type_id,date_format(if(update_time is not null,update_time,create_time),"%Y-%m-%d") update_time FROM lh_pretty_hold_8 WHERE del_flag=0 AND is_open_vip=0 AND STATUS=0 and pretty_id not in (SELECT pretty_id FROM lh_pretty_hold_8 WHERE STATUS=0 AND is_open_vip=0 AND thaw_time<=now() AND del_flag=0 AND is_sell=1 AND pay_type !=0) union all
            SELECT hold_phone,pretty_id,pretty_type_id,date_format(if(update_time is not null,update_time,create_time),"%Y-%m-%d") update_time FROM lh_pretty_hold_9 WHERE del_flag=0 AND is_open_vip=0 AND STATUS=0 and pretty_id not in (SELECT pretty_id FROM lh_pretty_hold_9 WHERE STATUS=0 AND is_open_vip=0 AND thaw_time<=now() AND del_flag=0 AND is_sell=1 AND pay_type !=0) union all
            SELECT hold_phone,pretty_id,pretty_type_id,date_format(if(update_time is not null,update_time,create_time),"%Y-%m-%d") update_time FROM lh_pretty_hold_a WHERE del_flag=0 AND is_open_vip=0 AND STATUS=0 and pretty_id not in (SELECT pretty_id FROM lh_pretty_hold_a WHERE STATUS=0 AND is_open_vip=0 AND thaw_time<=now() AND del_flag=0 AND is_sell=1 AND pay_type !=0) union all
            SELECT hold_phone,pretty_id,pretty_type_id,date_format(if(update_time is not null,update_time,create_time),"%Y-%m-%d") update_time FROM lh_pretty_hold_b WHERE del_flag=0 AND is_open_vip=0 AND STATUS=0 and pretty_id not in (SELECT pretty_id FROM lh_pretty_hold_b WHERE STATUS=0 AND is_open_vip=0 AND thaw_time<=now() AND del_flag=0 AND is_sell=1 AND pay_type !=0) union all
            SELECT hold_phone,pretty_id,pretty_type_id,date_format(if(update_time is not null,update_time,create_time),"%Y-%m-%d") update_time FROM lh_pretty_hold_c WHERE del_flag=0 AND is_open_vip=0 AND STATUS=0 and pretty_id not in (SELECT pretty_id FROM lh_pretty_hold_c WHERE STATUS=0 AND is_open_vip=0 AND thaw_time<=now() AND del_flag=0 AND is_sell=1 AND pay_type !=0) union all
            SELECT hold_phone,pretty_id,pretty_type_id,date_format(if(update_time is not null,update_time,create_time),"%Y-%m-%d") update_time FROM lh_pretty_hold_d WHERE del_flag=0 AND is_open_vip=0 AND STATUS=0 and pretty_id not in (SELECT pretty_id FROM lh_pretty_hold_d WHERE STATUS=0 AND is_open_vip=0 AND thaw_time<=now() AND del_flag=0 AND is_sell=1 AND pay_type !=0) union all
            SELECT hold_phone,pretty_id,pretty_type_id,date_format(if(update_time is not null,update_time,create_time),"%Y-%m-%d") update_time FROM lh_pretty_hold_e WHERE del_flag=0 AND is_open_vip=0 AND STATUS=0 and pretty_id not in (SELECT pretty_id FROM lh_pretty_hold_e WHERE STATUS=0 AND is_open_vip=0 AND thaw_time<=now() AND del_flag=0 AND is_sell=1 AND pay_type !=0) union all
            SELECT hold_phone,pretty_id,pretty_type_id,date_format(if(update_time is not null,update_time,create_time),"%Y-%m-%d") update_time  FROM lh_pretty_hold_f WHERE del_flag=0 AND is_open_vip=0 AND STATUS=0 and pretty_id not in (SELECT pretty_id FROM lh_pretty_hold_f WHERE STATUS=0 AND is_open_vip=0 AND thaw_time<=now() AND del_flag=0 AND is_sell=1 AND pay_type !=0) 
        '''
...
if __name__ == "__main__":
    ...
    while True:
        ...
        # df_merge.to_csv("e:/user_storage1.csv")
