...
# @File : .py
# --------------------------------------
'''8位用户每日名片网今日数据统计表首次同步使用 -- 15分钟同步一次'''
import os
import sys
...
def tran_hold():
    try:
        ...
        #可转让 持有
        sql = '''
            select if(hold_phone,hold_phone,hold_user_id) hold_phone, pretty_type_id, date_format(thaw_time,"%Y-%m-%d %H:%i:%S") thaw_time,date_format(if(pay_time is not null,pay_time,create_time),"%Y-%m-%d %H:%i:%S") pay_time, is_sell, pay_type, date_format(create_time,"%Y-%m-%d %H:%i:%S") create_time, status from le_pretty_hold_0 where del_flag=0 and `status` in (0,1,2) and is_open_vip = 0 and (thaw_time<=now() or create_time<=now())  union all
            select if(hold_phone,hold_phone,hold_user_id) hold_phone, pretty_type_id, date_format(thaw_time,"%Y-%m-%d %H:%i:%S") thaw_time,date_format(if(pay_time is not null,pay_time,create_time),"%Y-%m-%d %H:%i:%S") pay_time, is_sell, pay_type, date_format(create_time,"%Y-%m-%d %H:%i:%S") create_time, status from le_pretty_hold_1 where del_flag=0 and `status` in (0,1,2) and is_open_vip = 0 and (thaw_time<=now() or create_time<=now())  union all
            ...
            select if(hold_phone,hold_phone,hold_user_id) hold_phone, pretty_type_id, date_format(thaw_time,"%Y-%m-%d %H:%i:%S") thaw_time,date_format(if(pay_time is not null,pay_time,create_time),"%Y-%m-%d %H:%i:%S") pay_time, is_sell, pay_type, date_format(create_time,"%Y-%m-%d %H:%i:%S") create_time, status from le_pretty_hold_3 where del_flag=0 and `status` in (0,1,2) and is_open_vip = 0 and (thaw_time<=now() or create_time<=now())  union all
            select if(hold_phone,hold_phone,hold_user_id) hold_phone, pretty_type_id, date_format(thaw_time,"%Y-%m-%d %H:%i:%S") thaw_time,date_format(if(pay_time is not null,pay_time,create_time),"%Y-%m-%d %H:%i:%S") pay_time, is_sell, pay_type, date_format(create_time,"%Y-%m-%d %H:%i:%S") create_time, status from le_pretty_hold_4 where del_flag=0 and `status` in (0,1,2) and is_open_vip = 0 and (thaw_time<=now() or create_time<=now())  union all
            select if(hold_phone,hold_phone,hold_user_id) hold_phone, pretty_type_id, date_format(thaw_time,"%Y-%m-%d %H:%i:%S") thaw_time,date_format(if(pay_time is not null,pay_time,create_time),"%Y-%m-%d %H:%i:%S") pay_time, is_sell, pay_type, date_format(create_time,"%Y-%m-%d %H:%i:%S") create_time, status from le_pretty_hold_5 where del_flag=0 and `status` in (0,1,2) and is_open_vip = 0 and (thaw_time<=now() or create_time<=now())  union all
            select if(hold_phone,hold_phone,hold_user_id) hold_phone, pretty_type_id, date_format(thaw_time,"%Y-%m-%d %H:%i:%S") thaw_time,date_format(if(pay_time is not null,pay_time,create_time),"%Y-%m-%d %H:%i:%S") pay_time, is_sell, pay_type, date_format(create_time,"%Y-%m-%d %H:%i:%S") create_time, status from le_pretty_hold_6 where del_flag=0 and `status` in (0,1,2) and is_open_vip = 0 and (thaw_time<=now() or create_time<=now())  union all
            select if(hold_phone,hold_phone,hold_user_id) hold_phone, pretty_type_id, date_format(thaw_time,"%Y-%m-%d %H:%i:%S") thaw_time,date_format(if(pay_time is not null,pay_time,create_time),"%Y-%m-%d %H:%i:%S") pay_time, is_sell, pay_type, date_format(create_time,"%Y-%m-%d %H:%i:%S") create_time, status from le_pretty_hold_7 where del_flag=0 and `status` in (0,1,2) and is_open_vip = 0 and (thaw_time<=now() or create_time<=now())  union all
            select if(hold_phone,hold_phone,hold_user_id) hold_phone, pretty_type_id, date_format(thaw_time,"%Y-%m-%d %H:%i:%S") thaw_time,date_format(if(pay_time is not null,pay_time,create_time),"%Y-%m-%d %H:%i:%S") pay_time, is_sell, pay_type, date_format(create_time,"%Y-%m-%d %H:%i:%S") create_time, status from le_pretty_hold_8 where del_flag=0 and `status` in (0,1,2) and is_open_vip = 0 and (thaw_time<=now() or create_time<=now())  union all
            select if(hold_phone,hold_phone,hold_user_id) hold_phone, pretty_type_id, date_format(thaw_time,"%Y-%m-%d %H:%i:%S") thaw_time,date_format(if(pay_time is not null,pay_time,create_time),"%Y-%m-%d %H:%i:%S") pay_time, is_sell, pay_type, date_format(create_time,"%Y-%m-%d %H:%i:%S") create_time, status from le_pretty_hold_9 where del_flag=0 and `status` in (0,1,2) and is_open_vip = 0 and (thaw_time<=now() or create_time<=now())  union all
            select if(hold_phone,hold_phone,hold_user_id) hold_phone, pretty_type_id, date_format(thaw_time,"%Y-%m-%d %H:%i:%S") thaw_time,date_format(if(pay_time is not null,pay_time,create_time),"%Y-%m-%d %H:%i:%S") pay_time, is_sell, pay_type, date_format(create_time,"%Y-%m-%d %H:%i:%S") create_time, status from le_pretty_hold_a where del_flag=0 and `status` in (0,1,2) and is_open_vip = 0 and (thaw_time<=now() or create_time<=now())  union all
            select if(hold_phone,hold_phone,hold_user_id) hold_phone, pretty_type_id, date_format(thaw_time,"%Y-%m-%d %H:%i:%S") thaw_time,date_format(if(pay_time is not null,pay_time,create_time),"%Y-%m-%d %H:%i:%S") pay_time, is_sell, pay_type, date_format(create_time,"%Y-%m-%d %H:%i:%S") create_time, status from le_pretty_hold_b where del_flag=0 and `status` in (0,1,2) and is_open_vip = 0 and (thaw_time<=now() or create_time<=now())  union all
            select if(hold_phone,hold_phone,hold_user_id) hold_phone, pretty_type_id, date_format(thaw_time,"%Y-%m-%d %H:%i:%S") thaw_time,date_format(if(pay_time is not null,pay_time,create_time),"%Y-%m-%d %H:%i:%S") pay_time, is_sell, pay_type, date_format(create_time,"%Y-%m-%d %H:%i:%S") create_time, status from le_pretty_hold_c where del_flag=0 and `status` in (0,1,2) and is_open_vip = 0 and (thaw_time<=now() or create_time<=now())  union all
            select if(hold_phone,hold_phone,hold_user_id) hold_phone, pretty_type_id, date_format(thaw_time,"%Y-%m-%d %H:%i:%S") thaw_time,date_format(if(pay_time is not null,pay_time,create_time),"%Y-%m-%d %H:%i:%S") pay_time, is_sell, pay_type, date_format(create_time,"%Y-%m-%d %H:%i:%S") create_time, status from le_pretty_hold_d where del_flag=0 and `status` in (0,1,2) and is_open_vip = 0 and (thaw_time<=now() or create_time<=now())  union all
            select if(hold_phone,hold_phone,hold_user_id) hold_phone, pretty_type_id, date_format(thaw_time,"%Y-%m-%d %H:%i:%S") thaw_time,date_format(if(pay_time is not null,pay_time,create_time),"%Y-%m-%d %H:%i:%S") pay_time, is_sell, pay_type, date_format(create_time,"%Y-%m-%d %H:%i:%S") create_time, status from le_pretty_hold_e where del_flag=0 and `status` in (0,1,2) and is_open_vip = 0 and (thaw_time<=now() or create_time<=now())  union all
