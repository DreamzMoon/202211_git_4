...
# @File : .py
# --------------------------------------
'''8位用户每日名片网今日数据统计表首次同步使用 -- 13分钟同步一次'''
import os
import sys
    ...
    try:
        ...
        for hold_table_type in hold_table_type_list:
            ...
            pretty_hold_sql = '''
                ...
                where del_flag=0 and `status`=3 and date_format(if(update_time!='8888-08-08',update_time,create_time), '%%Y-%%m-%%d') <= now()
            ''' % hold_table_type
...
def tran_hold():
    try:
        ...
        #可转让 持有
        sql = '''
            select if(hold_phone,hold_phone,hold_user_id) hold_phone, pretty_type_id, date_format(thaw_time,"%Y-%m-%d") thaw_time,date_format(if(pay_time is not null,pay_time,create_time),"%Y-%m-%d") pay_time, is_sell, pay_type, date_format(create_time,"%Y-%m-%d") create_time, status from le_pretty_hold_0 where del_flag=0 and `status` in (0,1,2) and is_open_vip = 0 and (thaw_time<=now() or create_time<=now())  union all
            select if(hold_phone,hold_phone,hold_user_id) hold_phone, pretty_type_id, date_format(thaw_time,"%Y-%m-%d") thaw_time,date_format(if(pay_time is not null,pay_time,create_time),"%Y-%m-%d") pay_time, is_sell, pay_type, date_format(create_time,"%Y-%m-%d") create_time, status from le_pretty_hold_1 where del_flag=0 and `status` in (0,1,2) and is_open_vip = 0 and (thaw_time<=now() or create_time<=now())  union all
            select if(hold_phone,hold_phone,hold_user_id) hold_phone, pretty_type_id, date_format(thaw_time,"%Y-%m-%d") thaw_time,date_format(if(pay_time is not null,pay_time,create_time),"%Y-%m-%d") pay_time, is_sell, pay_type, date_format(create_time,"%Y-%m-%d") create_time, status from le_pretty_hold_2 where del_flag=0 and `status` in (0,1,2) and is_open_vip = 0 and (thaw_time<=now() or create_time<=now())  union all
            select if(hold_phone,hold_phone,hold_user_id) hold_phone, pretty_type_id, date_format(thaw_time,"%Y-%m-%d") thaw_time,date_format(if(pay_time is not null,pay_time,create_time),"%Y-%m-%d") pay_time, is_sell, pay_type, date_format(create_time,"%Y-%m-%d") create_time, status from le_pretty_hold_3 where del_flag=0 and `status` in (0,1,2) and is_open_vip = 0 and (thaw_time<=now() or create_time<=now())  union all
            select if(hold_phone,hold_phone,hold_user_id) hold_phone, pretty_type_id, date_format(thaw_time,"%Y-%m-%d") thaw_time,date_format(if(pay_time is not null,pay_time,create_time),"%Y-%m-%d") pay_time, is_sell, pay_type, date_format(create_time,"%Y-%m-%d") create_time, status from le_pretty_hold_4 where del_flag=0 and `status` in (0,1,2) and is_open_vip = 0 and (thaw_time<=now() or create_time<=now())  union all
            select if(hold_phone,hold_phone,hold_user_id) hold_phone, pretty_type_id, date_format(thaw_time,"%Y-%m-%d") thaw_time,date_format(if(pay_time is not null,pay_time,create_time),"%Y-%m-%d") pay_time, is_sell, pay_type, date_format(create_time,"%Y-%m-%d") create_time, status from le_pretty_hold_5 where del_flag=0 and `status` in (0,1,2) and is_open_vip = 0 and (thaw_time<=now() or create_time<=now())  union all
            select if(hold_phone,hold_phone,hold_user_id) hold_phone, pretty_type_id, date_format(thaw_time,"%Y-%m-%d") thaw_time,date_format(if(pay_time is not null,pay_time,create_time),"%Y-%m-%d") pay_time, is_sell, pay_type, date_format(create_time,"%Y-%m-%d") create_time, status from le_pretty_hold_6 where del_flag=0 and `status` in (0,1,2) and is_open_vip = 0 and (thaw_time<=now() or create_time<=now())  union all
            select if(hold_phone,hold_phone,hold_user_id) hold_phone, pretty_type_id, date_format(thaw_time,"%Y-%m-%d") thaw_time,date_format(if(pay_time is not null,pay_time,create_time),"%Y-%m-%d") pay_time, is_sell, pay_type, date_format(create_time,"%Y-%m-%d") create_time, status from le_pretty_hold_7 where del_flag=0 and `status` in (0,1,2) and is_open_vip = 0 and (thaw_time<=now() or create_time<=now())  union all
            select if(hold_phone,hold_phone,hold_user_id) hold_phone, pretty_type_id, date_format(thaw_time,"%Y-%m-%d") thaw_time,date_format(if(pay_time is not null,pay_time,create_time),"%Y-%m-%d") pay_time, is_sell, pay_type, date_format(create_time,"%Y-%m-%d") create_time, status from le_pretty_hold_8 where del_flag=0 and `status` in (0,1,2) and is_open_vip = 0 and (thaw_time<=now() or create_time<=now())  union all
            select if(hold_phone,hold_phone,hold_user_id) hold_phone, pretty_type_id, date_format(thaw_time,"%Y-%m-%d") thaw_time,date_format(if(pay_time is not null,pay_time,create_time),"%Y-%m-%d") pay_time, is_sell, pay_type, date_format(create_time,"%Y-%m-%d") create_time, status from le_pretty_hold_9 where del_flag=0 and `status` in (0,1,2) and is_open_vip = 0 and (thaw_time<=now() or create_time<=now())  union all
            select if(hold_phone,hold_phone,hold_user_id) hold_phone, pretty_type_id, date_format(thaw_time,"%Y-%m-%d") thaw_time,date_format(if(pay_time is not null,pay_time,create_time),"%Y-%m-%d") pay_time, is_sell, pay_type, date_format(create_time,"%Y-%m-%d") create_time, status from le_pretty_hold_a where del_flag=0 and `status` in (0,1,2) and is_open_vip = 0 and (thaw_time<=now() or create_time<=now())  union all
            select if(hold_phone,hold_phone,hold_user_id) hold_phone, pretty_type_id, date_format(thaw_time,"%Y-%m-%d") thaw_time,date_format(if(pay_time is not null,pay_time,create_time),"%Y-%m-%d") pay_time, is_sell, pay_type, date_format(create_time,"%Y-%m-%d") create_time, status from le_pretty_hold_b where del_flag=0 and `status` in (0,1,2) and is_open_vip = 0 and (thaw_time<=now() or create_time<=now())  union all
            select if(hold_phone,hold_phone,hold_user_id) hold_phone, pretty_type_id, date_format(thaw_time,"%Y-%m-%d") thaw_time,date_format(if(pay_time is not null,pay_time,create_time),"%Y-%m-%d") pay_time, is_sell, pay_type, date_format(create_time,"%Y-%m-%d") create_time, status from le_pretty_hold_c where del_flag=0 and `status` in (0,1,2) and is_open_vip = 0 and (thaw_time<=now() or create_time<=now())  union all
            select if(hold_phone,hold_phone,hold_user_id) hold_phone, pretty_type_id, date_format(thaw_time,"%Y-%m-%d") thaw_time,date_format(if(pay_time is not null,pay_time,create_time),"%Y-%m-%d") pay_time, is_sell, pay_type, date_format(create_time,"%Y-%m-%d") create_time, status from le_pretty_hold_d where del_flag=0 and `status` in (0,1,2) and is_open_vip = 0 and (thaw_time<=now() or create_time<=now())  union all
            select if(hold_phone,hold_phone,hold_user_id) hold_phone, pretty_type_id, date_format(thaw_time,"%Y-%m-%d") thaw_time,date_format(if(pay_time is not null,pay_time,create_time),"%Y-%m-%d") pay_time, is_sell, pay_type, date_format(create_time,"%Y-%m-%d") create_time, status from le_pretty_hold_e where del_flag=0 and `status` in (0,1,2) and is_open_vip = 0 and (thaw_time<=now() or create_time<=now())  union all
            select if(hold_phone,hold_phone,hold_user_id) hold_phone, pretty_type_id, date_format(thaw_time,"%Y-%m-%d") thaw_time,date_format(if(pay_time is not null,pay_time,create_time),"%Y-%m-%d") pay_time, is_sell, pay_type, date_format(create_time,"%Y-%m-%d") create_time, status from le_pretty_hold_f where del_flag=0 and `status` in (0,1,2) and is_open_vip = 0 and (thaw_time<=now() or create_time<=now())
        '''
...
def delete_yes_data():
    try:
        ...
        delete_sql = '''delete from user_storage_eight_today where day_time != CURRENT_DATE'''
...
if __name__ == "__main__":
    ...
    while True:
        ...
        df_merge.to_sql('user_storage_eight_today', con=conn_analyze, if_exists="append", index=False)
        run_end = time.time()
