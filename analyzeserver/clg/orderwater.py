...
def clg_tran_good_all():
    try:
        ...
        for d in order_data:
            if d["carry_unionid"]:
                d["carry_unionid"] = int(d["carry_unionid"])
