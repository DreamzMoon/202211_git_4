    ...
    try:
        ...
        if old_filter_pay_type_7 != filter_pay_type_7:
            pay_type_7 = {-1: "未知", 0: "信用点", 1: "诚聊余额", 2: "诚聊通余额", 3: "微信", 4: "支付宝", 5: "后台", 6: "银行卡",
             7: "诚聊通佣金", 8: "诚聊通红包"}
            old_type_list = [pay_type_7.get(int(old_type)) for old_type in old_filter_pay_type_7]
            new_type_list = [pay_type_7.get(int(new_type)) for new_type in filter_pay_type_7]
        ...
        if old_filter_pay_type_8 != filter_pay_type_8:
            ...
            old_type_list = [pay_type_8.get(int(old_type)) for old_type in old_filter_pay_type_8]
            new_type_list = [pay_type_8.get(int(new_type)) for new_type in filter_pay_type_8]
